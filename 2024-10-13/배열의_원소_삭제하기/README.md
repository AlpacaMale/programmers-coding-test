...
리스트 컴프리헨션과 조건문을 이용해서 filter를 만들어 쉽게 해결할 수 있다.

```python
def solution(arr, delete_list):
    return [number for number in arr if number not in delete_list]
```

[1]: https://school.programmers.co.kr/learn/courses/30/lessons/181844
